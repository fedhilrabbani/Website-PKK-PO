        ...
        <div class="form-container">
            <form>
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" id="quantity" name="quantity" placeholder="Masukkan kuantiti makanan">
                </div>
                <div class="mb-3">
                    <label for="deskripsi" class="form-label">Deskripsi Makanan</label>
                    <textarea class="form-control" id="deskripsi" rows="4" placeholder="Masukkan deskripsi makanan"></textarea>
                </div>
